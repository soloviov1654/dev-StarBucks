...
const cupDiscount = document.querySelector(".cup-discount");
const discountChange = window.matchMedia("(max-width: 1024px)");

function cupContentChanger(e) {
	if (e.matches) {
		cupDiscount.innerHTML = "+";
    } else {
        cupDiscount.innerHTML = "45%";
    }
}

cupContentChanger(discountChange);
discountChange.addEventListener("change", cupContentChanger); 